      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="hori"><a href="contact.fssai">Contact Us</a></li>
          </ul>
        ...
        <div class="container-fluid"> 
          ...
          <section class="section-form-margin-top">
            <div class="container"> 
              ...
              <div class="row">
                <div class="col-md-12  col-xs-12">
                  <div class="form-group"> <a href="assesment-question.fssai">
                    <input style="width:150px;"  type="button" class="form-control login-btn btn" value="Start Assessment" />
                    </a> </div>
                </div>
                <div class="col-md-2 hidden-xs"></div>
              </div>
