...
function searchManageCourseContent(){
	...
	$(".displayNone").css("display","block");
		...
		$.each(mainData1 , function(i , obj)
		{
			...
			$('#newTable').append('<tr id="tableRow"><td>'+ j++ +'</td><td>'+ obj[3]+'</td><td>'+ obj[1] +'</td><td>'+ obj[0] +'</td><td>'+ obj[4] +'</td><td>'+ obj[5] +'</td><td><input type="hidden" id="contentNameLabel" value="'+ obj[6] +'" />'+  obj[6] +'</td><td><input type="hidden" id="contentLinkLabel" value="'+ obj[2] +'" />'+ obj[2] +'</td><td><input type="hidden" id="idLabel" value="'+ obj[7] +'" /> <a href="#" onClick="editCourseContent();">edit</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onClick="deleteCourseContent();">delete</a></td></tr>');
		});
		}
		});
	return result;
 ...
 <div class="form-group">
                                                    <div>
                                                        <ul class="lab-no">
                                                            ...
                                                            <li class="style-li error-red"><cf:errors path="contentName" cssClass="error" /></li>
                                                        </ul>
                                                    </div>
                                               ...
                                               <div class="form-group">
                                                    <div>
                                                        <ul class="lab-no">
                                                            ...
                                                            <li class="style-li error-red"><cf:errors path="contentLink" cssClass="error" />  </li>
                                                        </ul>
                                                    </div>
...
<a href="#testt" class="pull-right" onclick="searchManageCourseContent();">Search according to your need</a>   
