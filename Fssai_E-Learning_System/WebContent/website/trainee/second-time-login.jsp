          ...
          <div class="col-xs-12">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="active hori"><a href="second-time-login.fssai">Second Time Login Home Page</a></li>
            ...
            <div class="row">
              <div class="col-xs-12">
                <div class="page-header">
                  <h1 id="timeline">Current Enrolled Course</h1>
                </div>
                <ul class="timeline">
                  <li>
                  ...
                  <li>
                    ...
                    <div class="timeline-panel">
                      ...
                      <div class="timeline-body">
                        <p>Attend Training</p>
                        <p><a href="training.html">Online</a> | Classroom</p>
                      </div>
                    </div>
                  </li>
                  <li class="timeline-inverted">
                ...
                <ul>
                <li>GHP-GMP* Certification Course <span class="text-success"><strong>(Basic)</strong></span></li>
                <li>GHP-GMP* Certification Course <span class="text-success"><strong>(Advance)</strong></span></li>
                <li>HACCP Course for Meat, Fish <span class="text-success"><strong>(Special)</strong></span></li>
                </ul>
              </div>
            </div>
          </div>
