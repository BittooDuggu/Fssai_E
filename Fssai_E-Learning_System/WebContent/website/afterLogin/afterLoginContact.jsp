    ...
    <div id="wrapper"> 
        ...
        <ul class="sidebar-nav">
            ...
            <ul class="dropdown-menu">
              ...
              <li> <a href="admit-card.html">Generate Admin Card</a> </li>
        ...
        <div class="container-fluid"> 
              ...
              <!-- vertical button -->
              <div class="row">
            <div class="col-lg-12"> <a href="#menu-toggle" class="vertical-menu-position-btn" id="menu-toggle"> <i class="fa fa-bars"></i> <span class="orange-font">Welcome Trainee Mr. Lorem </span> </a> </div>
          </div>
              ...
              <div class="container-fluid">
            <div class="row">
                  <h2 class="text-center course-heading-color">Let Us Help You!</h2>
                ...
                <form>
                    ...
                    <textarea class="form-control" placeholder="Enter Your Message (250 Words)"></textarea>
                  </div>
                      <input style="margin-top:20px; width:100px;"  type="button" class="form-control login-btn btn" value="Submit" />
                    </form>
              </div>
                  <div class="col-md-2 hidden-xs"> </div>
                </div>
