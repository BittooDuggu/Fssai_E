...
function searchTrainingPartnameList(){
		...
		{
			$('#newTable').append('<tr id="tableRow"><td>'+j++ +'</td><td>'+obj[1]+'</td><td><a href="onLoadTrainingPartnerCenterId.fssai?id='+obj[0]+'">'+obj[2]+'</a></td></tr>');
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <span class="orange-font">Welcome Mr. Lorem </span> </a>
                            </div>
                        </div>
